...
class ContextManager:
  ...
  # error_snapshots
    # wenxiaobai_20250611-170731_error.png (Binary or non-text file)

    # wenxiaobai_20250611-170753_error.png (Binary or non-text file)

    # wenxiaobai_20250612-130017_error.png (Binary or non-text file)
...
# =========================================
# 环境变量文件，包含 API Keys 等敏感信息
.env
.env.*.local
*.env

# 本地配置文件（用于覆盖 config.yaml 中的某些设置，方便本地调试）
config_local.yaml
*_local.yaml
...
# =========================================
# 以下规则不应被忽略，它们是项目的重要组成部分

# [X] 不要忽略测试文件！它们是代码的一部分。
# test_*.py

# [!] pytest.ini 通常是项目配置的一部分，应该被版本控制以确保测试一致性。
# 如果你的 pytest.ini 包含个人路径或敏感信息，应将其重命名为 pytest_local.ini 并忽略后者。
# pytest.ini
  ```
